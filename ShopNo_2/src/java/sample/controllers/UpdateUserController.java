...
public class UpdateUserController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        boolean user = dao.updateUser(userID, userName, pass, roleID, address, phone, birthday);
        request.getRequestDispatcher("UserManagementController").forward(request, response);
    }
